...
For information on managing virtual machine snapshots, refer to the Broadcom documentation https://techdocs.broadcom.com/[Broadcom Technical Documentation^].
